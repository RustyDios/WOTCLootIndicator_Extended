...
var config bool NAME_COLOUR_BYTEAM, HPBAR_COLOUR_BYTEAM, SHIELDBAR_COLOUR, SHIELDBAR_COLOUR_BYTEAM_FRIENDS, SHIELDBAR_COLOUR_BYTEAM_ENEMIES, SHIELDBAR_COLOUR_FROSTLEGION;
var config bool NAME_USE_FULLNAMES, TEXT_COLOUR_BYTEAM, ICONS_COLOUR_BYTEAM, ICONS_COLOUR_BYTEXT;

var config bool SHOW_CLASSICONS, SHOW_LOOT, REQUIRE_SCANNING, PERSISTANT_SCANS, SHOW_STATS_ON_ENEMIES, SHOW_STATS_ON_FRIENDS, SHOW_BARS_ON_FRIENDLY, SHOW_FRIENDS_NAME, SHOW_ENEMIES_NAME;
...
var config string SpecialBarColours_Health_bIsSpecial, SpecialBarColours_Health_bIsAChosen, SpecialBarColours_Shield_bIsSpecial, SpecialBarColours_Shield_bIsAChosen;
...
var config float numSegments_Health, numSegments_Shield;
